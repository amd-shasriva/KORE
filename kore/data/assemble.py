...
def _agentic_row_is_heldout(rec: dict) -> bool:
    ...
    Delegates to the single authoritative, fail-closed split decision
    (:func:`kore.tasks.registry.is_heldout_record`) so the task / FAMILY / arch /
    dtype holdout rules stay defined in exactly one place (taxonomy split)."""
