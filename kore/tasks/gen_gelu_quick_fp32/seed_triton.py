"""GENERATED seed Triton kernel for the gelu_quick (fp32) activation.

Elementwise gelu_quick, 2D-tiled, fp32 math, tl.float32 store. A correct-but-naive starting
