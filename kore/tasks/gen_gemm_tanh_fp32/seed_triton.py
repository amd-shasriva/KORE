"""GENERATED seed Triton GEMM + fused epilogue for gemm_tanh (fp32).
...
def gemm_tanh(a: torch.Tensor, b: torch.Tensor) -> torch.Tensor:
    M, K = a.shape
    K2, N = b.shape
