"""GENERATED seed Triton kernel for the reciprocal (fp16) activation.

Elementwise reciprocal, 2D-tiled, fp32 math, tl.float16 store. A correct-but-naive starting
