"""GENERATED seed Triton kernel for the reciprocal (fp32) activation.

Elementwise reciprocal, 2D-tiled, fp32 math, tl.float32 store. A correct-but-naive starting
