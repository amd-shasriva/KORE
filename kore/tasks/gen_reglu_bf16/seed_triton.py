"""GENERATED seed Triton kernel for the reglu (bf16) fusion.
...
@triton.jit
def _reglu_kernel(a_ptr, b_ptr, o_ptr, sa, sb, so, N, BLOCK_N: tl.constexpr):
    row = tl.program_id(0)
    col = tl.program_id(1)
...
def reglu(a: torch.Tensor, b: torch.Tensor) -> torch.Tensor:
    ...
    _reglu_kernel[grid](a, b, o, a.stride(0), b.stride(0), o.stride(0), N,
