"""GENERATED breadth block-sparse GEMM seed (bf16). Correct partial-fusion starting point:
the (data-dependent) sparsity selection is done host-side in torch, the dense GEMM
runs in this Triton kernel (fp32 accumulate, tl.bfloat16 store). 2D tiling + K-mask
