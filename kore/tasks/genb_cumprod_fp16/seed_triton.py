"""GENERATED breadth cumprod seed (fp16). x[..., L] -> cumulative product over last dim.
One program per flattened row; a sequential fp32 running-product scan over L (naive
but correct). The policy replaces the serial loop with a parallel prefix scan. tl.float16 store."""
