"""GENERATED breadth cv_conv2d_5x5_s1_d1 seed (bf16). Naive direct grouped conv2d (nchw, K=5 S=1 D=1) vs torch F.conv2d; one program per (n, cout, oh), fp32 accumulate over (cin, kh, kw), output width vectorized. Implicit-GEMM / channel-blocking headroom. tl.bfloat16 store."""
