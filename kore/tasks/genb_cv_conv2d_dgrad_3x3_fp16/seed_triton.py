"""GENERATED breadth cv_conv2d_dgrad_3x3 seed (fp16). Naive conv2d dInput / dgrad (K=3, stride 1) vs torch.nn.grad.conv2d_input; one program per (n, cin, ih) accumulating grad_y * weight over (cout, kh, kw). The hard training backward kernel. tl.float16 store."""
