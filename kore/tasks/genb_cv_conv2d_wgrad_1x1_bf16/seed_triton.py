"""GENERATED breadth cv_conv2d_wgrad_1x1 seed (bf16). Naive conv2d dWeight / wgrad (K=1, stride 1) vs torch.nn.grad.conv2d_weight; one program per (cout, cin) reducing grad_y * x over (n, oh, ow) per tap. The hard training backward kernel. tl.bfloat16 store."""
