"""GENERATED breadth cv_conv2d_wgrad_3x3 seed (fp16). Naive conv2d dWeight / wgrad (K=3, stride 1) vs torch.nn.grad.conv2d_weight; one program per (cout, cin) reducing grad_y * x over (n, oh, ow) per tap. The hard training backward kernel. tl.float16 store."""
