"""GENERATED breadth cv_conv3d_1x1x1_s1 seed (bf16). Naive direct conv3d (K=1x1x1, S=1) vs torch F.conv3d; one program per (n, cout, od, oh), fp32 accumulate over (cin, kd, kh, kw), output width vectorized. Volumetric implicit-GEMM headroom. tl.bfloat16 store."""
