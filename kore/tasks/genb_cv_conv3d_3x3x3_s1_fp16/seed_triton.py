"""GENERATED breadth cv_conv3d_3x3x3_s1 seed (fp16). Naive direct conv3d (K=3x3x3, S=1) vs torch F.conv3d; one program per (n, cout, od, oh), fp32 accumulate over (cin, kd, kh, kw), output width vectorized. Volumetric implicit-GEMM headroom. tl.float16 store."""
