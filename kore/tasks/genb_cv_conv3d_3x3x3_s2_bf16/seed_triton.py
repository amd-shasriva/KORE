"""GENERATED breadth cv_conv3d_3x3x3_s2 seed (bf16). Naive direct conv3d (K=3x3x3, S=2) vs torch F.conv3d; one program per (n, cout, od, oh), fp32 accumulate over (cin, kd, kh, kw), output width vectorized. Volumetric implicit-GEMM headroom. tl.bfloat16 store."""
