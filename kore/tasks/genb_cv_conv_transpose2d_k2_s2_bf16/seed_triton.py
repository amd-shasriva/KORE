"""GENERATED breadth cv_conv_transpose2d_k2_s2 seed (bf16). Naive transposed conv2d / deconv (K=2, S=2) vs torch F.conv_transpose2d; gather form (scatter inverse) - one program per (n, cout, oh) with a stride-modulo source map, fp32 accumulate. Upsampling headroom. tl.bfloat16 store."""
