"""GENERATED breadth cv_conv_transpose2d_k4_s2 seed (fp16). Naive transposed conv2d / deconv (K=4, S=2) vs torch F.conv_transpose2d; gather form (scatter inverse) - one program per (n, cout, oh) with a stride-modulo source map, fp32 accumulate. Upsampling headroom. tl.float16 store."""
