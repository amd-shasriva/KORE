"""GENERATED breadth cv_im2col_3x3_s1 seed (bf16). Naive im2col / unfold (K=3, S=1) vs torch F.unfold; one program per (n, cin*kh*kw row, L-block) gathering the padded patch. The implicit-GEMM lowering primitive. tl.bfloat16 store."""
