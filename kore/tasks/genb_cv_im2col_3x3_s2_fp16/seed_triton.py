"""GENERATED breadth cv_im2col_3x3_s2 seed (fp16). Naive im2col / unfold (K=3, S=2) vs torch F.unfold; one program per (n, cin*kh*kw row, L-block) gathering the padded patch. The implicit-GEMM lowering primitive. tl.float16 store."""
