"""GENERATED breadth cv_winograd_filter_transform_f2x2 seed (fp16). Naive Winograd F(2x2,3x3) FILTER transform U = G.g.Gt (exact rational transform, unrolled per 3x3 filter) vs the batched-matmul oracle. tl.float16 store."""
