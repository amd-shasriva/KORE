"""GENERATED breadth cv_winograd_input_transform_f2x2 seed (bf16). Naive Winograd F(2x2,3x3) INPUT transform V = Bt.d.B (exact integer transform, unrolled per 4x4 tile) vs the batched-matmul oracle. tl.bfloat16 store."""
