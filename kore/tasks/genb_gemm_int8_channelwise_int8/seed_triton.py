"""GENERATED breadth GEMM seed: gemm_int8_channelwise (int8). Naive host dequant + a
...
def gemm_int8_channelwise(aq, asc, wq, wsc):
    a = _dq_a8(aq, asc, "tensor").to(torch.bfloat16)
