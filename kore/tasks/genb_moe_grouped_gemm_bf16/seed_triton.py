"""GENERATED breadth MoE seed: moe_grouped_gemm (bf16).

variable-M grouped (segmented) expert GEMM. Naive, COMPILING, CORRECT starting point: host-side routing/permute
...
def moe_grouped_gemm(hidden, w, expert_ids):
