"""GENERATED breadth MoE seed: moe_grouped_gemm_down (bf16).

grouped down projection (w2 stage) of the expert MLP. Naive, COMPILING, CORRECT starting point: host-side routing/permute
...
def moe_grouped_gemm_down(hidden, w, expert_ids):
