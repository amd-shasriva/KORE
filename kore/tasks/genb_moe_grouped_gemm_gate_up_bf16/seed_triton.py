"""GENERATED breadth MoE seed: moe_grouped_gemm_gate_up (bf16).

grouped gate/up projection (w1 stage) of the expert MLP. Naive, COMPILING, CORRECT starting point: host-side routing/permute
...
def moe_grouped_gemm_gate_up(hidden, w, expert_ids):
    return _grouped_mm(hidden, w, expert_ids)
