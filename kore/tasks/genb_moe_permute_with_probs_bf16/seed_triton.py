"""GENERATED breadth MoE seed: moe_permute_with_probs (bf16).

MoE permute of tokens AND their router probs together. Naive, COMPILING, CORRECT starting point: host-side routing/permute
