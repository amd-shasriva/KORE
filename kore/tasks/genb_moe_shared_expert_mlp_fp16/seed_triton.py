"""GENERATED breadth MoE seed: moe_shared_expert_mlp (fp16).

shared-expert MLP added to the routed-expert output. Naive, COMPILING, CORRECT starting point: host-side routing/permute
