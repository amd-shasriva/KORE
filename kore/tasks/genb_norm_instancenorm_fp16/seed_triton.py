"""GENERATED breadth norm_instancenorm seed (fp16) - InstanceNorm. One program per (n, c):
single-pass fp32 sum & sum-of-squares over the spatial L, normalize + affine, tl.float16 store."""
