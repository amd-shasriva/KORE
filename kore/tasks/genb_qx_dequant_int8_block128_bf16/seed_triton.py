"""GENERATED breadth quant seed: qx_dequant_int8_block128 (bf16). Naive host amax /
...
def qx_dequant_int8_block128(codes, scale):
    sf = scale.float().repeat_interleave(BLK, dim=1)
