"""GENERATED breadth quant seed: qx_dequant_int8_perchannel (bf16). Naive host amax /
...
def qx_dequant_int8_perchannel(codes, scale):
    sf = scale.float().expand(codes.shape[0], codes.shape[1])
