"""GENERATED breadth red_topk2 seed (fp16). x[M,N] -> the top-2 values per row,
...
answer is the top-2 values WITH MULTIPLICITY (``torch.sort(...)[:2]``), not the
2 largest DISTINCT values. Repeats are not an edge case here: fp16 has few
