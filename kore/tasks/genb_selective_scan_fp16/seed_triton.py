"""GENERATED breadth selective_scan seed (fp16). Mamba-1 selective SSM core.
...
h=dA*h+dBu; y=sum_n C*h + D_*u. Naive sequential scan (the policy fuses/chunks it). tl.float16 store."""
