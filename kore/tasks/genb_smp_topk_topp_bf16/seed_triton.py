"""GENERATED breadth smp_topk_topp seed (bf16). combined top-k then top-p renormalized probabilities. Naive but correct; the
...
def smp_topk_topp(x: torch.Tensor) -> torch.Tensor:
    K = 50
