"""GENERATED breadth smp_topp_renorm seed (bf16). top-p (nucleus) renormalized probabilities. Naive but correct; the
...
def smp_topp_renorm(x: torch.Tensor) -> torch.Tensor:
    M, N = x.shape
