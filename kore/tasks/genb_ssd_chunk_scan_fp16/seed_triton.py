"""GENERATED breadth ssd_chunk_scan seed (fp16). Simplified Mamba-2 SSD scalar-decay scan.
...
real SSD kernel processes time in chunks (matmul the intra-chunk term). tl.float16 store."""
