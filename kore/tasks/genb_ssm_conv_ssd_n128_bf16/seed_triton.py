"""GENERATED breadth ssm_conv_ssd_n128 seed (bf16). Mamba conv+SSM: causal depthwise conv
...
The policy fuses the conv into the scan kernel + chunks it. tl.bfloat16 store."""
