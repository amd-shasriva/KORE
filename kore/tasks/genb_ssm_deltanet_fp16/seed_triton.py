"""GENERATED breadth ssm_deltanet seed. (Gated) DeltaNet delta-rule linear attention.
...
@triton.jit
def _ssm_deltanet_kernel(q_ptr, k_ptr, v_ptr, be_ptr, y_ptr, H, L, Dh, s_b, s_h, s_l, s_d,
