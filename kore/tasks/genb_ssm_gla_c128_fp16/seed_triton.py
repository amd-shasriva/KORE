"""GENERATED breadth ssm_gla_c128 seed (fp16). Gated Linear Attention (per-key-dim
...
sequential scan (the policy chunks/parallelizes it). tl.float16 store."""
from __future__ import annotations
import torch, triton, triton.language as tl


@triton.jit
def _ssm_gla_c128_kernel(q_ptr, k_ptr, v_ptr, g_ptr, y_ptr, H, L, Dh, s_b, s_h, s_l, s_d,
                 DB: tl.constexpr):
    pid = tl.program_id(0)
    e = pid % Dh
    tmp = pid // Dh
