"""GENERATED breadth ssm_gla_c64 seed (fp16). Gated Linear Attention (per-key-dim
...
@triton.jit
def _ssm_gla_c64_kernel(q_ptr, k_ptr, v_ptr, g_ptr, y_ptr, H, L, Dh, s_b, s_h, s_l, s_d,
                 DB: tl.constexpr):
    pid = tl.program_id(0)
    e = pid % Dh
    tmp = pid // Dh
