"""GENERATED breadth ssm_linattn_relu seed. Causal linear attention, feature map relu
...
@triton.jit
def _ssm_linattn_relu_kernel(q_ptr, k_ptr, v_ptr, y_ptr, H, L, Dh, s_b, s_h, s_l, s_d,
                 DB: tl.constexpr):
    pid = tl.program_id(0)
    e = pid % Dh
    tmp = pid // Dh
