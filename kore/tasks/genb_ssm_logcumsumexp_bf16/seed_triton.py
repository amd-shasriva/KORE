"""GENERATED breadth ssm_logcumsumexp seed (bf16). Stable log-cumsum-exp over
...
(log-space) scan. tl.bfloat16 store."""
...
def _ssm_logcumsumexp_kernel(x_ptr, y_ptr, L, srow):
    ...
    for i in range(0, L):
        ...
        m = mn
        tl.store(y_ptr + base + i, (m + tl.log(s)).to(tl.bfloat16))
