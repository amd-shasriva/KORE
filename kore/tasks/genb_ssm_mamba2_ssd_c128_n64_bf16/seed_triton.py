"""GENERATED breadth ssm_mamba2_ssd_c128_n64 seed (bf16). Mamba-2 SSD, multi-head scalar decay.
...
@triton.jit
def _ssm_mamba2_ssd_c128_n64_kernel(x_ptr, dt_ptr, A_ptr, B_ptr, C_ptr, y_ptr, L, H, P, N,
...
def ssm_mamba2_ssd_c128_n64(x, dt, A, B_, C):
    B, L, H, P = x.shape
    N = B_.shape[-1]
    ...
    _ssm_mamba2_ssd_c128_n64_kernel[(B * H * P,)](
