"""GENERATED breadth ssm_selective_scan_n128 seed (bf16). Mamba-1 selective SSM core. u/delta[B,L,D],
...
y=sum_n C*h + D_*u. Naive sequential scan (the policy fuses/chunks it). tl.bfloat16 store."""
from __future__ import annotations
import torch, triton, triton.language as tl


@triton.jit
def _ssm_selective_scan_n128_kernel(u_ptr, delta_ptr, A_ptr, B_ptr, C_ptr, Dskip_ptr, y_ptr, L, D, N,
...
def ssm_selective_scan_n128(u, delta, A, B_, C, D_):
    Bsz, L, D = u.shape
    N = A.shape[1]
    ...
    _ssm_selective_scan_n128_kernel[(Bsz * D,)](
