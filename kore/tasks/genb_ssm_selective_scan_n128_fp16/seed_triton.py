"""GENERATED breadth ssm_selective_scan_n128 seed (fp16). Mamba-1 selective SSM core. u/delta[B,L,D],
...
y=sum_n C*h + D_*u. Naive sequential scan (the policy fuses/chunks it). tl.float16 store."""
