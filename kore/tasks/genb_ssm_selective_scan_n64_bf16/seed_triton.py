"""GENERATED breadth ssm_selective_scan_n64 seed (bf16). Mamba-1 selective SSM core. u/delta[B,L,D],
...
@triton.jit
def _ssm_selective_scan_n64_kernel(u_ptr, delta_ptr, A_ptr, B_ptr, C_ptr, Dskip_ptr, y_ptr, L, D, N,
...
def ssm_selective_scan_n64(u, delta, A, B_, C, D_):
    Bsz, L, D = u.shape
    N = A.shape[1]
    ...
    _ssm_selective_scan_n64_kernel[(Bsz * D,)](
