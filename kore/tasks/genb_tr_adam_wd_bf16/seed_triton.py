"""GENERATED breadth tr_adam_wd seed (bf16). Fused Adam-family step."""
from __future__ import annotations
import torch, triton, triton.language as tl


@triton.jit
def _tr_adam_wd_kernel(param_ptr, grad_ptr, exp_avg_ptr, exp_avg_sq_ptr, lr, wd, b1, b2, eps, step_size, bc2sqrt, numel, BLOCK: tl.constexpr):
    pid = tl.program_id(0)
...
def tr_adam_wd(param, grad, exp_avg, exp_avg_sq, lr, b1, b2, eps, wd, step):
    numel = param.numel()
    bc1 = 1.0 - b1 ** step
    step_size = lr / bc1
    ...
    _tr_adam_wd_kernel[grid](param, grad, exp_avg, exp_avg_sq, lr, wd, b1, b2, eps, step_size, bc2sqrt, numel, BLOCK=BLOCK, num_warps=4)
