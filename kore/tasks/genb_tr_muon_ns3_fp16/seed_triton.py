"""GENERATED breadth tr_muon_ns3 seed. (Nesterov) momentum + aspect-scaled decoupled update plus 3-iter Newton-Schulz orthogonalization implemented with naive Triton GEMM/normalization/axpby kernels. Returns (param, momentum_buffer)."""
