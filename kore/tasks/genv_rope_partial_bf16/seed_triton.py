"""GENERATED partial-rotary RoPE seed (bf16).
...
freqs[S,1,1,rot//2]. fp32 math, tl.bfloat16 store. Regenerate via generate_vendor_ops.py."""
...
def _rope_partial_kernel(x_ptr, f_ptr, y_ptr, B, H, D,
    ...
    tl.store(y_ptr + base + (offs + QUART) * sxd, (x2 * cos + x1 * sin).to(tl.bfloat16))
