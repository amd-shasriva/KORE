...
start frontier_pipeline \
    ...
    DATAGEN_STREAMS="frontierhip:runs/shards_frontierhip:data/v5frontierhip:2:kore-mine-frontierhip frontiertriton:runs/shards_frontiertriton:data/v5frontier:1:kore-mine-frontiertriton frontiertwins:runs/shards_frontier_twins:data/v5frontier_twins:0:kore-mine-frontiertwins hardpool:runs/shards_hardpool:data/v5hardpool:0:kore-mine-hardpool poolflydsl:runs/shards_pool_flydsl:data/v5pool_flydsl:0:kore-mine-poolflydsl hipreg:runs/shards_hipreg:data/v5hip:0:kore-mine-hipreg poolhip:runs/shards_hippool:data/v5hippool:0:kore-mine-poolhip+kore-factory frontier:runs/shards_frontier:data/v5frontier:0:kore-mine-frontier pooltriton:runs/shards_pooltriton:data/v5pooltriton:0:kore-mine-pooltriton" \
